...
var Graph = function (props) {
    ...
    return (_jsx(Box, __assign({ position: "relative" }, { children: _jsxs(Grid, __assign({ container: true, display: "flex", justifyContent: "center" }, { children: [_jsxs(Grid, __assign({ item: true, xs: 0.1, display: "flex", flexDirection: "column" }, { children: [_jsx(Item, __assign({ className: classes.leftItem1 }, { children: ((_a = contestStatistics === null || contestStatistics === void 0 ? void 0 : contestStatistics.PROFILE_DUPLICATE) === null || _a === void 0 ? void 0 : _a.percentage) || "_ _" })), _jsx(Item, __assign({ className: classes.leftItem2 }, { children: ((_b = contestStatistics === null || contestStatistics === void 0 ? void 0 : contestStatistics.TOTAL_PROFILES_UPLOADED) === null || _b === void 0 ? void 0 : _b.percentage) || "_ _" })), _jsx(Item, __assign({ className: classes.leftItem3 }, { children: ((_c = contestStatistics === null || contestStatistics === void 0 ? void 0 : contestStatistics.AWAITING_JOB_SEEKEER_CONSENT) === null || _c === void 0 ? void 0 : _c.percentage) ||
